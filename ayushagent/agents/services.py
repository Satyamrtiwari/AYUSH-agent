...
class OpenAIService:
    ...
    def __init__(self):
        ...
        self.api_key = getattr(settings, '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', 'sk-demo-key')
